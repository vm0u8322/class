...
# 🌟 預先下載 Faster-Whisper 模型，確保雲端啟動後 100% 本地加載，免除漫長下載造成的超時與卡頓！
RUN python -c "from faster_whisper import download_model; download_model('tiny', output_dir='/home/user/app/tools/whisper_models')"
